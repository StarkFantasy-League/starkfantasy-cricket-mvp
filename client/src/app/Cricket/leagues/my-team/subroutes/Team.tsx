                                ...
                                {selectedPlayers[originalIndex] ? (
                                    ...
                                    >
                                        <img
                                            ...
                                            onClick={() =>
                                                handleShirtClick(originalIndex)
                                            }
                                        />
                                        {dropdownIndex === originalIndex && (
                                            <div className="absolute top-[110px] left-1/2 transform -translate-x-1/2 w-64 max-h-64 overflow-y-auto bg-slate-950/50 rounded-lg shadow-lg z-50">
