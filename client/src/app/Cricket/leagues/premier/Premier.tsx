  ...
  return (
    <div className="relative w-full h-screen text-white flex flex-col">
      ...
      <div className="ml-8 flex flex-col flex-grow">
        ...
        <div className="relative z-20 flex flex-col p-4 flex-grow">
          {user.isConnected ? (
            <>
              <div className="text-center mb-8">
                <h2 className="text-lg md:text-2xl tracking-[0.2em] uppercase">
                  Welcome to
                </h2>
                <h1 className="text-[40px] sm:text-[70px] md:text-[95px] lg:text-[90px] font-black mt-2">
