    ...
    const filteredPlayers = useMemo(() => {
        ...
        if (priceFilter !== "ALL") {
            if (priceFilter === "< 200") {
                ...
                result = result.filter(
                    (player) => player.price >= 200 && player.price <= 249
                );
                ...
                <div className="flex gap-[30px] flex-col lg:flex-row lg:gap-[80px] ">
                    <div className="flex flex-col w-[150px]">
                        ...
                        <div className="relative">
                            ...
                            <span className="absolute right-[-40px] top-1/2 transform -translate-y-1/2 text-white">
                ...
                <div className="relative flex items-end">
                    ...
                    >
                        <input
                            type="text"
                            placeholder={
                                isSearchExpanded ? "Search players..." : ""
                            }
