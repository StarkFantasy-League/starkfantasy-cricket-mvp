...
export default function SupportPage() {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-slate-950 w-full max-w-full overflow-x-hidden">
          ...
          <main className="flex-1 px-4 sm:px-6 lg:px-8">
            ...
            <div className="text w-[65%] mx-auto mb-[2rem] ">
                ...
                <p className="text-white text-[15px] ">
                    As a continuously evolving project, StarkFantasy League thrives on contributions. If you're interested in lending your expertise, we warmly invite you to explore our <a href="/"> <span className="text-orange-500">GitHub repository</span></a>. Here, you'll find opportunities to collaborate and help shape the future of our platform.
                </p>
                <p className="text-white text-[15px] mt-3">
                    Effective coordination is key to our collective success. To facilitate seamless communication among contributors, we encourage you join <a href="/"> <span className="text-orange-500">Telegram</span></a> and <a href="/"> <span className="text-orange-500">Discord</span></a>. By participating in these communities, you'll stay informed, share ideas, and work alongside fellow enthusiasts to enhance StarkFantasy League.
                </p>
            </div>
            ...
            <div className="text w-[65%] mx-auto mb-[2rem]">
                ...
                <p className="text-white text-[15px] mb-7">
                    Let's dive into the thrilling and unpredictable world of fantasy sport - where every move counts and the stakes are anything but ordinary. Welcome to StarkFantasy League.
                </p>
